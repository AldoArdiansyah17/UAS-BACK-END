...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO nilai (mahasiswa, mata_kuliah, nilai) VALUES ('$mahasiswa', '$mata_kuliah', '$nilai')";
    $conn->query($sql);
}
...
$result = $conn->query("SELECT * FROM nilai ORDER BY mahasiswa, mata_kuliah");
        ...
        ?>
            <tr>
                <?php if ($row['mahasiswa'] !== $current_mahasiswa): ?>
                    <td rowspan="<?= $conn->query("SELECT COUNT(*) AS count FROM nilai WHERE mahasiswa='{$row['mahasiswa']}'")->fetch_assoc()['count'] ?>">
